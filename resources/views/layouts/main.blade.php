...
<head>
    ...
    <title>@yield('title', 'TimeBridge')</title>
    <!-- Fonts -->
...
<body class="@yield('body-class', 'bg-white') text-gray-900 antialiased selection:bg-gray-900 selection:text-white flex flex-col min-h-screen">
    ...
    <header class="w-full bg-black text-white py-6">
        <div class="max-w-7xl mx-auto px-6 flex justify-between items-center">
            ...
            <nav class="hidden md:flex items-center gap-12">
                <a href="{{ url('/') }}" class="text-sm font-medium {{ Request::is('/') ? 'text-white underline underline-offset-4' : 'text-gray-300 hover:text-white' }} transition uppercase tracking-wide">Home</a>
                <a href="{{ route('about') }}" class="text-sm font-medium {{ Request::routeIs('about') ? 'text-white underline underline-offset-4' : 'text-gray-300 hover:text-white' }} transition uppercase tracking-wide">About Us</a>
                <a href="{{ route('products.index') }}" class="text-sm font-medium {{ Request::routeIs('products.*') ? 'text-white underline underline-offset-4' : 'text-gray-300 hover:text-white' }} transition uppercase tracking-wide">Products</a>
            </nav>
