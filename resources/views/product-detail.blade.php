        ...
        <div class="bg-white w-full max-w-5xl rounded-xl shadow-2xl overflow-hidden relative flex flex-col md:flex-row min-h-[600px]">
            ...
            <div class="w-full md:w-1/2 p-8 md:p-12 md:pr-16 flex flex-col justify-center">
                ...
                <div class="flex gap-4">
                    <button class="flex-grow bg-gray-900 text-white py-4 rounded-md font-medium text-lg hover:bg-black transition flex justify-center items-center gap-2 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
