            ...
            <div class="w-full md:w-1/2 p-8 md:p-12 md:pr-16 flex flex-col justify-center">
                ...
                <div class="flex gap-4">
                    ...
                    <form action="{{ route('favorites.store', $product->id) }}" method="POST">
                        @csrf
                        <button type="submit" class="w-16 h-14 flex items-center justify-center bg-gray-100 rounded-md hover:bg-gray-200 transition text-gray-600 hover:text-red-500">
