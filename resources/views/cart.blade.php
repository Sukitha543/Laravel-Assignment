...
<head>
    ...
    <title>Shopping Cart - TimeBridge</title>
    <!-- Fonts -->
    ...
    <main class="flex-grow pt-12 pb-12">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="w-full lg:w-2/3 bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
                ...
                <!-- Order Summary (Right) -->
                 <div class="w-full lg:w-1/3">
                    <div class="bg-white p-8 rounded-lg shadow-sm border border-gray-100">
                        ...
                        <button class="w-full bg-green-600 hover:bg-green-700 text-white font-medium py-3 rounded-md transition mb-4 shadow-sm">
                            Proceed to Checkout
                        </button>
